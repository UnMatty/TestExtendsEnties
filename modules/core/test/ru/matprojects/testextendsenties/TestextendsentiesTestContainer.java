package ru.matprojects.testextendsenties;
...
public class TestextendsentiesTestContainer extends TestContainer {

    public TestextendsentiesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/matprojects/testextendsenties/app.properties",
    ...
    public static class Common extends TestextendsentiesTestContainer {

        public static final TestextendsentiesTestContainer.Common INSTANCE = new TestextendsentiesTestContainer.Common();
